...
use crate::traits::util::{self, find_unelaborated_sizedness_optimisation_};
...
impl<'cx, 'tcx> SelectionContext<'cx, 'tcx> {
    ...
    fn assemble_candidates_from_caller_bounds<'o>(
        ...
        if let Some(bound) = find_unelaborated_sizedness_optimisation_(
            self.infcx,
            stack.obligation.predicate,
            stack.obligation.param_env.trait_clauses(),
        ) {
