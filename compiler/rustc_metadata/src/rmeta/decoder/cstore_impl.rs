...
provide! { tcx, def_id, other, cdata,
    ...
    windows_subsystem => { cdata.root.windows_subsystem }
    proc_macro_decls_static => { cdata.get_proc_macro_decls_static() }
    mono_collection_roots => { cdata.get_mono_collection_roots(tcx) }
