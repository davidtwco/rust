...
impl<I, T, E: rustc_serialize::Encoder> rustc_serialize::Encodable<E> for ty::Binder<I, T>
where
    I: Interner,
...
impl<I, T, D: rustc_serialize::Decoder> rustc_serialize::Decodable<D> for ty::Binder<I, T>
where
    I: Interner,
    I::BoundVarKinds: rustc_serialize::Decodable<D>,
    T: rustc_serialize::Decodable<D> + TypeVisitable<I>,
{
