...
fn main() {
    ...
    //~^^ ERROR evaluate(Binder { value: HostEffectPredicate { trait_ref: <MaskedStorage<GenericComp2<Pos>> as std::marker::Sized>, constness: Const }, bound_vars: [] }) = Ok(EvaluatedToOkModuloRegions)
}
