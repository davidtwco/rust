...
#[lang = "coerce_unsized"]
pub trait CoerceUnsized<T: ?Sized + ?MetaSized_> {
    // Empty.
}

// &mut T -> &mut U
#[unstable(feature = "coerce_unsized", issue = "18598")]
impl<'a, T: ?Sized + ?MetaSized_ + Unsize<U>, U: ?Sized + ?MetaSized_> CoerceUnsized<&'a mut U>
    for &'a mut T
{
}
// &mut T -> &U
#[unstable(feature = "coerce_unsized", issue = "18598")]
impl<'a, 'b: 'a, T: ?Sized + ?MetaSized_ + Unsize<U>, U: ?Sized + ?MetaSized_> CoerceUnsized<&'a U>
    for &'b mut T
{
}
// &mut T -> *mut U
#[unstable(feature = "coerce_unsized", issue = "18598")]
impl<'a, T: ?Sized + ?MetaSized_ + Unsize<U>, U: ?Sized + ?MetaSized_> CoerceUnsized<*mut U>
    for &'a mut T
{
}
// &mut T -> *const U
#[unstable(feature = "coerce_unsized", issue = "18598")]
impl<'a, T: ?Sized + ?MetaSized_ + Unsize<U>, U: ?Sized + ?MetaSized_> CoerceUnsized<*const U>
    for &'a mut T
{
}
...
// *mut T -> *mut U
#[unstable(feature = "coerce_unsized", issue = "18598")]
impl<T: ?Sized + ?MetaSized_ + Unsize<U>, U: ?Sized + ?MetaSized_> CoerceUnsized<*mut U>
    for *mut T
{
}
// *mut T -> *const U
#[unstable(feature = "coerce_unsized", issue = "18598")]
impl<T: ?Sized + ?MetaSized_ + Unsize<U>, U: ?Sized + ?MetaSized_> CoerceUnsized<*const U>
    for *mut T
{
}
...
// &T -> &U
#[unstable(feature = "dispatch_from_dyn", issue = "none")]
impl<'a, T: ?Sized + ?MetaSized_ + Unsize<U>, U: ?Sized + ?MetaSized_> DispatchFromDyn<&'a U>
    for &'a T
{
}
// &mut T -> &mut U
#[unstable(feature = "dispatch_from_dyn", issue = "none")]
impl<'a, T: ?Sized + ?MetaSized_ + Unsize<U>, U: ?Sized + ?MetaSized_> DispatchFromDyn<&'a mut U>
    for &'a mut T
{
}
// *const T -> *const U
#[unstable(feature = "dispatch_from_dyn", issue = "none")]
impl<T: ?Sized + ?MetaSized_ + Unsize<U>, U: ?Sized + ?MetaSized_> DispatchFromDyn<*const U>
    for *const T
{
}
// *mut T -> *mut U
#[unstable(feature = "dispatch_from_dyn", issue = "none")]
impl<T: ?Sized + ?MetaSized_ + Unsize<U>, U: ?Sized + ?MetaSized_> DispatchFromDyn<*mut U>
    for *mut T
{
}
