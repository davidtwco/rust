...
pub trait AsRef<T: ?Sized + ?MetaSized_>: ?MetaSized_ {
...
pub trait AsMut<T: ?Sized + ?MetaSized_>: ?MetaSized_ {
...
// As lifts over &
#[stable(feature = "rust1", since = "1.0.0")]
impl<T: ?Sized + ?MetaSized_, U: ?Sized + ?MetaSized_> AsRef<U> for &T
where
    T: AsRef<U>,
{
    #[inline]
...
// As lifts over &mut
#[stable(feature = "rust1", since = "1.0.0")]
impl<T: ?Sized + ?MetaSized_, U: ?Sized + ?MetaSized_> AsRef<U> for &mut T
where
    T: AsRef<U>,
{
    #[inline]
...
#[stable(feature = "rust1", since = "1.0.0")]
impl<T: ?Sized + ?MetaSized_, U: ?Sized + ?MetaSized_> AsMut<U> for &mut T
where
    T: AsMut<U>,
{
    #[inline]
